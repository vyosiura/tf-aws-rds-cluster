...
| <a name="requirement_aws"></a> [aws](#requirement\_aws) | >= 3.41, < 4.0.0 |

## Providers

| Name | Version |
|------|---------|
| <a name="provider_aws"></a> [aws](#provider\_aws) | >= 3.41, < 4.0.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_identifier"></a> [cluster\_identifier](#input\_cluster\_identifier) | Nome que será atribuido ao novo cluster. Conflita com `cluster_identifier_prefix` | `string` | n/a | yes |
| <a name="input_engine_version"></a> [engine\_version](#input\_engine\_version) | Major version da engine que será utilizada. Caso não seja específicado, será utilizado a versão estável mais recente. | `string` | n/a | yes |
| <a name="input_master_password"></a> [master\_password](#input\_master\_password) | Senha do usuário master que será criado na inicialização do cluster. Não é necessário se snapshot\_identifier ou replicate\_source\_db for utilizado. | `string` | n/a | yes |
| <a name="input_master_username"></a> [master\_username](#input\_master\_username) | Nome do usuário master que será criado na inicialização do cluster. Não é necessário se snapshot\_identifier ou replicate\_source\_db for utilizado. | `string` | n/a | yes |
| <a name="input_parameter_group_family"></a> [parameter\_group\_family](#input\_parameter\_group\_family) | O parameter group que será associado ao cluster | `string` | n/a | yes |
...
| <a name="input_deletion_protection"></a> [deletion\_protection](#input\_deletion\_protection) | Habilita a proteção de deletar o database. Para deletar a instância deve ser `false` o valor | `bool` | `true` | no |
